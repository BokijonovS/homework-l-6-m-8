...
from app.views import FoodTypeViewSet, FoodViewSet, CommentViewSet
...
router.register('foodtype', FoodTypeViewSet, basename='foodtype')
...
urlpatterns = [
    ...
    path('djoser-auth/v1/', include('djoser.urls')),
